...
function apply(){
  try{
    ...
    d.Bhadohi=[["Rahi Tourist Bungalow, Bhadohi","Bhadohi, Uttar Pradesh","" ]];
    d.Budaun=[["Rahi Tourist Bungalow, Budaun","Budaun, Uttar Pradesh","" ]];
    ...
    d.Farrukhabad=[["Rahi Tourist Bungalow, Sankisa","Sankisa Road, Sankisa Basantpur, Uttar Pradesh 209652",""]];
    d.Ghazipur=[["Rahi Tourist Bungalow, Ghazipur","Ghazipur, Uttar Pradesh","" ]];
    d.Hapur=[["Rahi Tourist Bungalow, Garhmukteshwar","Garhmukteshwar, Hapur, Uttar Pradesh","" ]];
    ...
    d['Kanpur Nagar']=[["Rahi Tourist Bungalow, Bithoor","Nana Rao Peshwa Smarak Park, Bithoor, Kanpur, Uttar Pradesh-209203","9415609454"]];
