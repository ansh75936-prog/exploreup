/* ExploreUP Arya AI — FREE runtime bridge
 ...
 * This bridge only exposes safe local/free helpers for future use.
 */
(function(){
  'use strict';
  ...
  AI.askInternet=async function(query,city){return localAnswer(query,city)};
  AI.knowledge=K;
