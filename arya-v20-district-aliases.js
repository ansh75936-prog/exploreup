/* ExploreUP V20 — Arya Hinglish understanding layer. Data-preserving. */
(function(){
'use strict';
...
window.ExploreUPAryaAliases={aliases:A,normalize,intentOf:q=>{const n=norm(q);for(const[r,t]of I)if(r.test(n))return t;return '';},commonWords:C,intents:I.map(x=>x[1])};
})();
